...
public class SerachDialog extends DialogFragment implements
    ...
    public static SerachDialog newInstance(List items) {
        SerachDialog multiSelectExpandableFragment = new
                SerachDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.activity_search_dialog, null);
        setData(rootView);
