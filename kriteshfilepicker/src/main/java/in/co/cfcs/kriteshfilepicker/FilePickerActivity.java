...
import in.co.cfcs.kriteshfilepicker.fragments.DocFragment;
import in.co.cfcs.kriteshfilepicker.fragments.DocPickerFragment;
import in.co.cfcs.kriteshfilepicker.fragments.MediaPickerFragment;
import in.co.cfcs.kriteshfilepicker.fragments.PhotoPickerFragmentListener;
import in.co.cfcs.kriteshfilepicker.utils.FragmentUtil;
...
public class FilePickerActivity extends BaseFilePickerActivity
  ...
  @Override protected void initView() {
    ...
    if (intent != null) {
      ...
      if (selectedPaths != null) {
        ...
        if (PickerManager.getInstance().getMaxCount() == 0) {
          selectedPaths.clear();
        }
  ...
  @Override public void onItemSelected() {
    ...
    if (PickerManager.getInstance().getMaxCount() == 0 && currentCount == 0) {
      returnData(
